...
A small quality-of-life [Nexus](https://github.com/RaidcoreGG/NEXUS) addon for [Guild Wars 2](https://www.guildwars2.com/) that helps you keep track of your mouse cursor during combat.

When entering combat, the cursor switches to either the game’s high- or low-contrast version, depending on your preference, and returns to normal once combat ends.

Additionally, the cursor can temporarily revert to normal when hovering over certain game or addon UI during combat.
